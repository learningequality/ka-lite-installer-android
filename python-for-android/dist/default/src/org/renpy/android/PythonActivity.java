...
public class PythonActivity extends Activity implements Runnable {
 ...
 //       this.getWindow().requestFeature(Window.FEATURE_PROGRESS);  //eli
   //     this.getWindow().requestFeature(Window.FEATURE_ACTION_BAR_OVERLAY);
     //   this.getWindow().setFeatureInt(Window.FEATURE_PROGRESS, Window.PROGRESS_VISIBILITY_ON);//eli
       // this.getActionBar().hide(); //eli
     //   WebView.setWebContentsDebuggingEnabled(true);  //eli
